document.addEventListener('DOMContentLoaded', () => {
    ...
    // Chapter definitions — 中1数学（啓林館）
    const chapters = [
        { num: 1, title: '第1章 正の数・負の数', start: 12, end: 54 },
        { num: 2, title: '第2章 文字の式', start: 58, end: 84 },
        { num: 3, title: '第3章 方程式', start: 88, end: 110 },
        { num: 4, title: '第4章 変化と対応', start: 114, end: 144 },
        { num: 5, title: '第5章 平面図形', start: 148, end: 178 },
        { num: 6, title: '第6章 空間図形', start: 182, end: 216 },
        { num: 7, title: '第7章 データの活用', start: 220, end: 244 }
    ];
    ...
    function getImageSrc(pageNum) {
        ...
        return `images/math_g1_keirinkan/page_${pdfPageNum.toString().padStart(4, '0')}.png`;
    }
